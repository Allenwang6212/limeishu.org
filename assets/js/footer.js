...
var content_EN = '<ul class="icons"><li><a href="tel:' + tel + '" class="icon fa fa-phone" title="Call US"><span class="label">Phone</span></a></li><li><a href="tel:' + fax + '" class="icon fa fa-fax" title="傳真給紀念館"><span class="label">FAX</span></a></li><li><a href="' + fb + '" class="icon fa fa-facebook" title="Li Mei-Shu Memorial Gallery (李梅樹紀念館)"><span class="label">Facebook</span></a></li><li><a href="' + mail + '" class="icon fa fa-envelope" title="寄信給紀念館"><span class="label">Email</span></a></li><li><a href="' + github + '" class="icon fa fa-github" title="取得紀念館網站原始碼"><span class="label">GitHub</span></a></li></ul><ul class="copyright"><li>&copy; ' + year + '. 李梅樹紀念館 Li Mei-shu Memorial Gallery.</li><li> Design: LIT Team</li><li>本著作係採用<a rel="license" href="http://creativecommons.org/licenses/by-nc-nd/4.0/">創用 CC BY-NC-ND 4.0 ISO</a>授權.</li></ul>';

var content_JP = '<ul class="icons"><li><a href="tel:' + tel + '" class="icon fa fa-phone" title="電話聯絡紀念館"><span class="label">Phone</span></a></li><li><a href="tel:' + fax + '" class="icon fa fa-fax" title="傳真給紀念館"><span class="label">FAX</span></a></li><li><a href="' + fb + '" class="icon fa fa-facebook" title="Li Mei-Shu Memorial Gallery (李梅樹紀念館)"><span class="label">Facebook</span></a></li><li><a href="' + mail + '" class="icon fa fa-envelope" title="寄信給紀念館"><span class="label">Email</span></a></li><li><a href="' + github + '" class="icon fa fa-github" title="取得紀念館網站原始碼"><span class="label">GitHub</span></a></li></ul><ul class="copyright"><li>&copy; ' + year + '. 李梅樹紀念館 Li Mei-shu Memorial Gallery.</li><li> Design: LIT Team</li><li>本著作係採用<a rel="license" href="http://creativecommons.org/licenses/by-nc-nd/4.0/">創用 CC BY-NC-ND 4.0 ふたなり</a>授權.</li></ul>';
